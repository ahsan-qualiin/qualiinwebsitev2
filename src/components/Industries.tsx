...
const IndustryCard = ({ title, description, image, className }: IndustryCardProps) => {
    return (
            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-[120px] relative z-10">
                ...
                <div className="flex flex-col gap-10">
                    ...
                    <IndustryCard
                        ...
                        description="Tailored quality assurance and compliance strategies for hospitals and healthcare institutions"
