...
export const Hero = ({ openContactModal }: { openContactModal?: () => void }) => {
    return (
        <section className="relative w-full bg-primary-600 overflow-hidden">
            ...
            <div className="max-w-[1440px] mx-auto px-0 py-[134px] flex flex-col items-center gap-7">
                ...
                <Button
                    onClick={openContactModal}
                    className="bg-secondary-500 text-secondary-900 rounded-xl px-5 py-1 h-[47px] text-[32px] font-normal hover:bg-secondary-500/90 flex items-center gap-2"
                >
